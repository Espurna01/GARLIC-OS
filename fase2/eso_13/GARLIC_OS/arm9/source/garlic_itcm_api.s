...
@; R0: direccion de la cadena de caractgeres
@; R1: max char
_ga_getstring:
	push {r4, lr}
	cmp r1, #1
	...
	ldr r4, =_gd_pidz			@; R4 = dirección _gd_pidz
	ldr r3, [r4]
	and r2, r3, #0xf			@; R2 = ventana de salida (zócalo actual)
	bl _gt_getstring
	pop {r4, pc}
...
_ga_getXYbuttons:
	push {r4-r5, lr}
	ldr r4, =_gi_za
	ldrb r4, [r4]				@; Zocalo en foco
	ldr r5, =_gd_pidz
	ldr r5, [r5]
	mov r0, #0
	and r5, #0xf				@; zocalo
	cmp r4, r5
	bleq _gt_getXYbuttons
	bl _gp_WaitForVBlank		@; Leer como maximo a 60 hz
	pop {r4-r5, pc}
.end
